# Striks Whisperer - File Structure Overview

This document explains the purpose of each file in the Striks Whisperer project to help you understand how the application works.
...
3. **Application Logic (app.js)**
   ...
   - Displays the transcript and allows copying to clipboard
...
5. The transcript is shown to the user
6. User can copy the text to clipboard for use in other applications
